...
require('utils').dump(casper.cli.get('config'))
var configFilename = casper.cli.get('conf') ||  "config.js"
require('utils').dump("using config: " + configFilename);
...
casper.on('page.error', function (msg, trace) {
    ...
    this.echo(utils.format('  javascript error: %s ', error.msg), 'ERROR');
    this.echo('    at ' + error.file + ' (line ' +  error.line + ')', 'warning');
    if (error.func) this.echo('  function: ' + error.func, 'warning');
...
casper.on('run.complete', function () {
    ...
    this.echo('', 'INFO');
    this.echo(utils.format('Errors: %s ', dataObj.errors.length), 'ERROR');
